...
#    This creates analysis/output/bb_matches.csv
...
# 3. Run the analysis (CSV files are automatically found in output/)
...
This generates a plot showing how the number of matches for the tracked preceding vehicle (boxID 0) changes across frames. With 20% shrink factor, match counts typically range from 90-251.
